...
- [[directions/wave-transparent-composites/inbox|待分配事项]]
- [[directions/wave-transparent-composites/log|方向日志]]
- [[directions/wave-transparent-composites/memory/tag_taxonomy|方向标签]]
- [[directions/wave-transparent-composites/memory/term_aliases|方向术语]]
- [[directions/wave-transparent-composites/memory/error_log|错误记录]]
- [[directions/wave-transparent-composites/memory/decision_log|决定记录]]
...
- 4. [[directions/wave-transparent-composites/wiki/papers/Liu-2024-Entropy-ZrP2O7|中熵焦磷酸盐：相变抑制]]。
- 5. [[directions/wave-transparent-composites/wiki/papers/Liu-2024-Porous-Si3N4|双溶剂模板多孔氮化硅]]。
- 7. [[directions/wave-transparent-composites/wiki/papers/Wen-2026-Laminated-SiO2f-SiO2|层合穿刺SiO2f/SiO2]]。
- 8. [[directions/wave-transparent-composites/wiki/papers/Chen-2026-Hybrid-Fibers-BN|Si3N4/SiO2混编纤维增强BN]]。
- 9. [[directions/wave-transparent-composites/wiki/papers/Wen-2026-High-Entropy-Disilicate|高熵二硅酸盐：高通量与机器学习]]。

PDF原件未复制。[[directions/wave-transparent-composites/raw/zotero_imports/wave-transparent-composites-BSQRX4DM/import_plan|9篇导入清单及状态]]；来源映射见[sources.json](docs/ingestion-2026-09-17/sources.json)。

## 综合

- [[directions/wave-transparent-composites/synthesis/group-baseline-and-benchmarks-2026-09-18|组内材料与指标基础、国际公开性能参照]]：已形成带条件的比较矩阵；有限文献不能确立全球纪录或统一落后百分比。
...
- [[directions/wave-transparent-composites/raw/zotero_imports/reviews-GS7STC5N/import_plan|综述集合清单及状态]]；[来源映射](docs/ingestion-reviews-2026-09-18/sources.json)。
