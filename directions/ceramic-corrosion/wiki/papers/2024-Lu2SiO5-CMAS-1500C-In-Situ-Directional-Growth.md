...
pdf_attachment_name: Tian 等 - 2024 - In-situ observation and directional growth of Ca2Lu8(SiO4)6O2 in Lu2SiO5 attacked by CMAS at 1500 °C.pdf
doi: 10.1016/j.surfcoat.2024.131196
topics:
...
- 1300 °C/50 h 的约 50 μm 引自 [18]，即 [[directions/ceramic-corrosion/wiki/papers/2019-RE2SiO5-CMAS-General-Trend]]。原文指标是衰退层厚度，包含反应产物层，与本文最深渗透指标不同。
...
- 与 [[directions/ceramic-corrosion/wiki/papers/2023-RE2SiO5-CMAS-In-Situ-Degradation]] 的 Er 观察可作有限对照，但 RE、保温时间及本篇时序不确定性同时存在；不能直接将差异归因于 Lu 磷灰石形成焓。
...
| 页面 | 具体待复核论断及原因 |
|---|---|
| [[directions/ceramic-corrosion/wiki/claims/Phase-Decomposition-Intergranular-Infiltration]] | “纯相直接分解、TEM 排除偏聚、唯一主因”的强度须按 E1/E5/E6 重评 |
| [[directions/ceramic-corrosion/wiki/claims/CMAS-Viscosity-1500C-RE-Effect-Weakening]] | 撤回本篇作为半径反转的第二次独立验证；本文未测黏度，跨温度倍数不具比较资格（E7/E8） |
| [[directions/ceramic-corrosion/wiki/claims/CMAS-Corrosion-Enthalpy-RE-Radius-Trend]] | 50 μm 及形成焓均为既有来源，不新增独立验证（E7/E8） |
| [[directions/ceramic-corrosion/wiki/gaps/Cooling-Precipitation-Coating-Integrity]] | “保温无反应、仅冷却析出”存在图文时序冲突；损伤因果未研究（E3/E8） |
| [[directions/ceramic-corrosion/wiki/gaps/CMAS-Corrosion-Data-1500C]] | Lu 单成分范围不能证明跨 RE 规律；其他体系缺口仍需检索（E7/E8） |
| [[directions/ceramic-corrosion/wiki/topics/Ceramic Corrosion]] | 原位时序、四倍劣化、相失稳主因及双篇共识须重核 |
| [[directions/ceramic-corrosion/synthesis/literature-map]]、[[directions/ceramic-corrosion/synthesis/core-argument-map]] | #16 的证据强度与“半径—高温失效”链条须拆分观察和解释 |
| [[directions/ceramic-corrosion/synthesis/review-outline]] | 不以“仅冷却析出/唯一分解根源/四倍劣化”继续组织确定性章节 |
| [[directions/ceramic-corrosion/synthesis/open-questions]]、[[directions/ceramic-corrosion/synthesis/research-positioning]] | 问题前提与高熵抑制分解设想须按局部未决降格为候选，不冒充已确认研究目标 |
