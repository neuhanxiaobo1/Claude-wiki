...
- §4.2 的 1300 °C 成分趋势指向 [25]，即 [[directions/ceramic-corrosion/wiki/papers/2019-RE2SiO5-CMAS-General-Trend]]。该文实际测的是衰退层厚度，从溶解前沿到含磷灰石层顶部；本文称其为 infiltration depth，不能据名称直接把两个指标合并。
...
| 页面 | 具体影响 |
|---|---|
| [[directions/ceramic-corrosion/wiki/claims/CMAS-Viscosity-1500C-RE-Effect-Weakening]] | 黏度应标计算；“致弱化/方向反转”需限定为解释，检查非单调曲线、缺测与跨温度指标不一致 |
| [[directions/ceramic-corrosion/wiki/claims/CMAS-Corrosion-Enthalpy-RE-Radius-Trend]] | 1300 °C 引自 2019，量热引自 Costa，不能新增独立实验计数或作为普适机制证明 |
| [[directions/ceramic-corrosion/wiki/claims/Garnet-Product-RE2SiO5-CMAS]] | 仅报道主要磷灰石不等于排除微量石榴石，不能以未提及作绝对反证 |
| [[directions/ceramic-corrosion/wiki/gaps/Cooling-Precipitation-Coating-Integrity]] | Er 冷却现象可保留；起始温度是正文报告，损伤因果及七种推广尚未验证 |
| [[directions/ceramic-corrosion/wiki/gaps/CMAS-Corrosion-Data-1500C]] | 本文有七种但时长覆盖不全，不能称完整温度/成分矩阵或证明跨体系效应 |
| [[directions/ceramic-corrosion/wiki/gaps/High-Throughput-Screening-Transfer]] | 可推广为候选问题；“作者指出推广”和“尚未推广”须查原文与检索范围 |
| [[directions/ceramic-corrosion/wiki/topics/Ceramic Corrosion]] | 高温趋势、证据独立性、微结构排除及产物形成的共识措辞需限定 |
| [[directions/ceramic-corrosion/synthesis/literature-map]] | 统一数值比较和强度评价需重审 |
| [[directions/ceramic-corrosion/synthesis/review-outline]] | 将“低黏度导致规律反转”作已证实章节前提的结构须重审 |
| [[directions/ceramic-corrosion/synthesis/open-questions]] | 半径弱化、冷却损伤及数据缺口的问题前提需重核 |
| [[directions/ceramic-corrosion/synthesis/research-positioning]]、[[directions/ceramic-corrosion/synthesis/core-argument-map]] | 已有主线中对 #47 的弱化/反转证据定位需按 E5–E7 重审 |

与 [[directions/ceramic-corrosion/wiki/papers/2019-RE2SiO5-CMAS-General-Trend]] 的来源关系已核对；本轮不改其正文，也不提前复核 2024 Lu₂SiO₅ 论文。后者与本文的“两个独立高温证据”能支持什么，需该篇复核后判断。
