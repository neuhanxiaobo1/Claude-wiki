...
2026-09-09再接续：筛选报告及CSV已上传，完整标签calude_wiki_scopus_screening_complete，远程核验a383aef3b6261769800865b5cb702fd53faa57ce。随后新增 [[memory/ceramic_corrosion_reading_rules]]，只作用陶瓷腐蚀方向；当前10篇按完整作者元数据均记internal。后续组外论文需补一作/通讯作者发表时单位、国家/地区、发表时间和有日期来源的当前方向，并维护 [[synthesis/external-literature-register]]；不按collection判断组别。本次规则与分类增补尚未提交上传，未开始新论文入库。
