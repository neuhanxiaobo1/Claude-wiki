...
- 新建：无。
- 更新：wiki/claims 下八页、index、规则完善计划、context_policy、error_log、log。索引注明旧 gap/topic/综合结论仍待修订。
...
- 新建：无。
- 更新：wiki/gaps 下五页、index、计划、context_policy、error_log、log。
...
- 新建：无。
- 更新：两个 topic、synthesis/literature-map、index、计划、context_policy、error_log、log。
...
- 新建：docs/collection-candidates-2026-09-08.md。
...
- 新建：[[wiki/papers/2025-RE2SiO5-CMAS-Multilayer-Stacking-Screening]]，processed/checked（主文声明范围）。
...
- 新建：[[wiki/reviews/CMAS-Review-Section-1-Evaluation-and-Comparability]]。
...
- 新建：[[wiki/papers/2024-M-YTaO4-CMAS-Grain-Boundary-Infiltration]]；[[wiki/papers/2019-RE2Si2O7-CMAS-1300-1500C]]，均processed/checked（声明范围）。
...
- 新建：[[docs/progress-and-background-2026-09-09]]；随本版本上传两篇新增论文页和第一节正文。
